...
namespace jrHTTP {
    ...
    private:
        ...
        void http_handler(std::shared_ptr<jrNetWork::TCP::ClientSocket> client);
        ...
        void parser_request_line(std::shared_ptr<jrNetWork::TCP::ClientSocket> client, hash_map& request_line_table, int& ret_code);
        void parser_request_head(std::shared_ptr<jrNetWork::TCP::ClientSocket> client, hash_map& request_head_table, int& ret_code);
        void parser_request_body(std::shared_ptr<jrNetWork::TCP::ClientSocket> client, int content_length, std::string& request_body);
